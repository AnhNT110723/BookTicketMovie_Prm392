...
(N'Inception', N'A thief who steals corporate secrets through dream-sharing technology', 148, N'English', '2010-07-16', 'https://youtube.com/inception-trailer', 'https://example.com/inception-poster.jpg', 8.8, N'Christopher Nolan', N'Sci-Fi, Thriller', 120000.00, 1, 1),
(N'Pulp Fiction', N'The lives of two mob hitmen, a boxer, and a gangster intertwine', 154, N'English', '1994-10-14', 'https://youtube.com/pulpfiction-trailer', 'https://example.com/pulpfiction-poster.jpg', 8.9, N'Quentin Tarantino', N'Action, Drama', 110000.00, 1, 0),
(N'The Avengers', N'Superheroes team up to save the world', 143, N'English', '2012-05-04', 'https://youtube.com/avengers-trailer', 'https://example.com/avengers-poster.jpg', 8.0, N'Joss Whedon', N'Action, Adventure', 150000.00, 1, 1),
(N'Bố Già', N'Vietnamese family comedy drama', 128, N'Vietnamese', '2021-03-12', 'https://youtube.com/bogia-trailer', 'https://example.com/bogia-poster.jpg', 7.5, N'Trấn Thành', N'Comedy, Drama', 100000.00, 1, 0),
(N'Hai Phượng', N'Vietnamese action thriller', 98, N'Vietnamese', '2019-02-22', 'https://youtube.com/haiphuong-trailer', 'https://example.com/haiphuong-poster.jpg', 6.8, N'Ngô Thanh Vân', N'Action, Thriller', 95000.00, 1, 0),

-- Trending Movies from HomeActivity
(N'Avatar: The Way of Water', N'Set more than a decade after the events of the first film...', 192, N'English', '2022-12-16', 'https://youtube.com/avatar2-trailer', 'https://example.com/avatar2-poster.jpg', 7.6, N'James Cameron', N'Action, Adventure, Sci-Fi', 180000.00, 1, 1),
(N'Top Gun: Maverick', N'After thirty years, Maverick is still pushing the envelope...', 130, N'English', '2022-05-27', 'https://youtube.com/topgun-trailer', 'https://example.com/topgun-poster.jpg', 8.3, N'Joseph Kosinski', N'Action, Drama', 160000.00, 1, 1),
(N'Black Panther: Wakanda Forever', N'Queen Ramonda, Shuri, M''Baku, Okoye and the Dora Milaje...', 161, N'English', '2022-11-11', 'https://youtube.com/blackpanther2-trailer', 'https://example.com/blackpanther2-poster.jpg', 6.7, N'Ryan Coogler', N'Action, Adventure, Drama', 170000.00, 1, 1),
(N'Spider-Man: No Way Home', N'With Spider-Man''s identity now revealed, Peter asks Doctor Strange for help...', 148, N'English', '2021-12-17', 'https://youtube.com/spiderman-trailer', 'https://example.com/spiderman-poster.jpg', 8.4, N'Jon Watts', N'Action, Adventure, Sci-Fi', 165000.00, 1, 1),

-- Featured Movies from HomeActivity
(N'The Batman', N'When a sadistic serial killer begins murdering key political figures in Gotham...', 176, N'English', '2022-03-04', 'https://youtube.com/batman-trailer', 'https://example.com/batman-poster.jpg', 7.8, N'Matt Reeves', N'Action, Crime, Drama', 155000.00, 1, 0),
(N'Doctor Strange in the Multiverse of Madness', N'Doctor Strange teams up with a mysterious teenage girl...', 126, N'English', '2022-05-06', 'https://youtube.com/doctorstrange2-trailer', 'https://example.com/doctorstrange2-poster.jpg', 6.9, N'Sam Raimi', N'Action, Adventure, Fantasy', 145000.00, 1, 0),
(N'Minions: The Rise of Gru', N'A fanboy of a supervillain supergroup known as the Vicious 6...', 87, N'English', '2022-07-01', 'https://youtube.com/minions-trailer', 'https://example.com/minions-poster.jpg', 6.5, N'Kyle Balda', N'Animation, Adventure, Comedy', 125000.00, 1, 0),
(N'Thor: Love and Thunder', N'Thor enlists the help of Valkyrie, Korg and ex-girlfriend Jane Foster...', 119, N'English', '2022-07-08', 'https://youtube.com/thor4-trailer', 'https://example.com/thor4-poster.jpg', 6.2, N'Taika Waititi', N'Action, Adventure, Comedy', 140000.00, 1, 0);
